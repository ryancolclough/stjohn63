(() => {
  ...
  dock.addEventListener('click',e=>{const btn=e.target.closest('[data-action]');if(!btn)return;const action=btn.dataset.action;if(action==='contents')location.hash='#contents';if(action==='amendments')location.hash='#governance-records';if(action==='pdf')window.open('docs/official-bylaws-2023.pdf','_blank');if(action==='search')openSheet('Search',`<input id="search-box" class="search-input" type="search" placeholder="Search the By-Laws" autofocus><div id="search-results"></div>`)});
