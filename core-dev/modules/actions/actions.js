...
export default function register(ctx){
  ...
  function renderActions(filter="active"){
    ...
    const content=`<div class="backline"><button data-route="dashboard">‹ Dashboard</button></div>
      <section class="hero"><div class="eyebrow">Temple Board Work</div><h1>Action Centre</h1><p>Assign, track, complete, and preserve follow-up work created by reviews, amendments, meetings, and operations.</p><div class="rule"></div></section>
